...
public class RoyalFlushAIP {
	...
	public void holdsCards() {
		...
		Assert.assertEquals("Royal Flush", strategy.isStrategyNeeded(AIPHand));
	}
	...
	public void storeAIPPokerHand(DataTable table) throws Throwable {
		...
		HTBHand[7] = new String[5];
		HTBHand[8] = new String[5];
		...
		HTBHand[7][0] = data.get(5).get(0);
		HTBHand[7][1] = data.get(5).get(1);
		HTBHand[7][2] = data.get(5).get(2);
		HTBHand[7][3] = data.get(5).get(3);
		HTBHand[7][4] = data.get(5).get(4);
		
		HTBHand[8][0] = data.get(6).get(0);
		HTBHand[8][1] = data.get(6).get(1);
		HTBHand[8][2] = data.get(6).get(2);
		HTBHand[8][3] = data.get(6).get(3);
		HTBHand[8][4] = data.get(6).get(4);
	...
	public void determineTheWinner() throws Throwable {
		...
		Assert.assertEquals(true, strategy.getScore(AIPHand) > strategy.getScore(HTBHand[7]));
		Assert.assertEquals(true, strategy.getScore(AIPHand) > strategy.getScore(HTBHand[8]));
