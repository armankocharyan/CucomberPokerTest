...
public class ThreeOfKindStepDefinitions {
	...
	public void storePokerHand(DataTable table) throws Throwable {
		...
		//System.out.println("Given a three of a kind poker hand in any order\n");
	...
	public void checkCardsForThreeOfKind() throws Throwable {
		
		Permutation.resetCounter();
		Permutation.permuteEachHand(hand, Permutation.THREE_OF_KIND);
