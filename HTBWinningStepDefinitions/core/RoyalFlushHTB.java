...
public class RoyalFlushHTB {
	...
	public void storeAIPPokerHand(DataTable table) throws Throwable {
		...
		AIPHand[7] = new String[5];
		AIPHand[8] = new String[5];
		...
		AIPHand[7][0] = data.get(7).get(0);
		AIPHand[7][1] = data.get(7).get(1);
		AIPHand[7][2] = data.get(7).get(2);
		AIPHand[7][3] = data.get(7).get(3);
		AIPHand[7][4] = data.get(7).get(4);
		
		AIPHand[8][0] = data.get(8).get(0);
		AIPHand[8][1] = data.get(8).get(1);
		AIPHand[8][2] = data.get(8).get(2);
		AIPHand[8][3] = data.get(8).get(3);
		AIPHand[8][4] = data.get(8).get(4);
	...
	public void determineTheWinner() throws Throwable {
		...
		Assert.assertEquals(true, strategy.getScore(HTBHand) > strategy.getScore(AIPHand[7]));
		Assert.assertEquals(true, strategy.getScore(HTBHand) > strategy.getScore(AIPHand[8]));
